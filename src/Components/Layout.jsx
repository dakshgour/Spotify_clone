...
function Layout({children,currentSong,setAddNewPlaylist, AddNewPlaylist,playlistData,setPlaylistData}) {
...
/>
      ...
      <div id='MainContent' className="flex flex-1 overflow-hidden">
        <SideBar setAddNewPlaylist={setAddNewPlaylist} AddNewPlaylist={AddNewPlaylist} playlistData={playlistData} setPlaylistData={setPlaylistData}/>
